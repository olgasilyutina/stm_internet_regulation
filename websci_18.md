...
``` r
med_drug <- dt_gath %>% dplyr::select(ind, country) #selecting columns to get text-country dataset
...
clusters_country <- as.data.frame(unlist(fastgreedy_main))
...
#trying to choose the best number of topics
#storage <- searchK(out$documents, out$vocab, K = c(30, 50, 70),  prevalence =~ membership, data = out$meta)
#storage$results
...
#igraph visualization under comment
...
col_topics = c("1"="#DAA520", "2"="#008000", "3"="#C71585",  "4"="#FF6347", "5"="#191970", "6"="#DC143C",  "7"="#008080", "8"="#87CEFA", "9"="#EE82EE", "10"="#FF4500")
...
![](websci_18_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-32-1.png)
...
![](websci_18_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-35-1.png)
...
![](websci_18_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-38-1.png)
